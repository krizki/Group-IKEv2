...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>Wismote Mote Type #Parser</description>
      <source EXPORT="discard">[CONTIKI_DIR]/apps/tinydtls/test-cert-parser/parser-test.c</source>
      <commands EXPORT="discard">make parser-test.wismote TARGET=wismote</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/apps/tinydtls/test-cert-parser/parser-test.wismote</firmware>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>31.60819226738758</x>
        <y>68.77735181911724</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>0.9090909090909091 0.0 0.0 0.9090909090909091 165.2652797569204 110.47513470989342</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
